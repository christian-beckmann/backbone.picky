...
// new methods since 0.2.0: getSelected, getDeselected, setMaxSelected
...
Backbone.Picky = (function (Backbone, _) {
    ...
    _.extend(Picky.MultiSelect.prototype, {
        ...
        // the selected model.
        select: function (model) {
            if (typeof this.maxSelectable === "undefined" || this.maxSelectable < 0 || this.maxSelectable > _.size(this.selected)) {
        ...
        /**
         * Change the maximum selectable Models,
         * TODO: if collection has more selected then the new max value, nothing happens
         * Infinite: set lower than 0 (-1 resets the border)
         * @param maxSelectable {int}
         * @returns {Backbone.Picky.MultiSelect}
         */
        setMaxSelectable: function (maxSelectable) {
            if (isNaN(maxSelectable)) {
                maxSelectable = -1;
            }
            this.maxSelectable = maxSelectable;
            return this;
        ...
        /**
         * Returns an array of all selected Models in Collection
         * @returns {Array}
         */
